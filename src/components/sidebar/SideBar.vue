         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     <router-link to="/app/chat" class="iq-waves-effect"><i class="las la-user-friends"></i><span>Chat</span></router-link>
                  </li>
                  <li>
                  ...
                  <li>
                     <router-link to="" class="iq-waves-effect"><i class="las la-video"></i><span>Label4</span></router-link>
                  </li>
                  <li>
                     <router-link to="" class="iq-waves-effect"><i class="las la-film"></i><span>Label5</span></router-link>
                  </li>
                  <li>
                     <router-link to="" class="iq-waves-effect"><i class="las la-bell"></i><span>Label6</span></router-link>
                  </li>
                  <li>
                     <router-link to="" class="iq-waves-effect"><i class="las la-file"></i><span>Label7</span></router-link>
                  </li>
                  <!-- <li>
                  ...
                  <li class="active">
                     <a href="#mailbox" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="true"><i class="ri-mail-line"></i><span>Email</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="mailbox" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        <li class="active"><a href="index.html"><i class="ri-inbox-line"></i>Inbox</a></li>
                        <li><a href="email-compose.html"><i class="ri-edit-line"></i>Email Compose</a></li>
                     </ul>
                  </li>
                  <li>
